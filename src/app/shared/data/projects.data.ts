...
export const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    type: "Open Source",
    image: "./projects/spartan_admin1.png",
    images: [
    ...
    description:
      "A production-ready Angular admin dashboard built with Spartan UI and Tailwind CSS. Features modern dashboards, user management, Kanban boards, calendar scheduling, AI assistant, authentication flows, and multilingual support.",
    techs: [
      "Angular 22",
      "TypeScript",
      "Spartan UI",
    ...
    website: "https://spartan-admin-dashboard.vercel.app/",
    highlights: [
      "Production-ready Angular 22 architecture with standalone components and lazy loading",
      "Complete admin suite including dashboards, user management, Kanban, calendar, and AI assistant",
      "Internationalization with English, French, Arabic, and full RTL support",
      "WCAG AA accessibility, dark mode, and responsive design",
    ],
    hasDetails: true,
  },
  {
